...
const CivilApplications = () => {
  return (
    <section className="section-civil-applications padding-global" id="applications" style={{ backgroundColor: '#ffffff', paddingTop: '2.25rem', paddingBottom: '2.25rem', borderBottom: '1px solid #bfdbfe' }}>
